    ...
    <div className="min-h-screen bg-[#050511] font-sans selection:bg-primary/30">
      ...
      <main className="pt-32 pb-20 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
          {/* Contact Form */}
          <div className="lg:col-span-2 bg-[linear-gradient(135deg,rgba(18,18,26,0.95)_0%,rgba(89,22,139,0.2)_100%)] backdrop-blur-md border border-[#C27AFF80] rounded-2xl p-8 md:p-12 shadow-[0_25px_50px_-12px_#9810FA66] shadow-[0_0_0px_1px_#AD46FF4D] relative overflow-hidden h-fit">
