  ...
  return (
    <div className="min-h-screen bg-[linear-gradient(180deg,#000000_0%,#3C0366_50%,#000000_100%)] font-sans p-4 md:p-8">
      ...
      <div className="bg-[linear-gradient(135deg,rgba(89,22,139,0.4)_0%,rgba(114,19,120,0.4)_100%)] border border-[#AD46FF33] rounded-3xl p-8 min-h-[80vh] md:min-h-screen flex flex-col items-center justify-center text-center">
        {/* Icon Container */}
        <div className="w-24 h-24 rounded-full bg-transparent flex items-center justify-center mb-6 shadow-[0_0_30px_#F0B100]">
          <LuCrown className="text-5xl text-[#F0B100]" />
        </div>

        {/* Text Content */}
        <h2 className="text-white text-3xl font-bold mb-4 tracking-wide">
          VIP Shop Opening Soon!
        </h2>
        <p className="text-[#DAB2FF] max-w-lg text-sm md:text-base leading-relaxed">
          Get ready for an exclusive shopping experience! Our VIP Shop will
          feature premium items, luxury rewards, and exclusive merchandise
          available only to our valued players.
        </p>
      </div>
    </div>
  );
